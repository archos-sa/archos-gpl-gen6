...
$(SAMBA_DIR)/.unpacked: $(DL_DIR)/$(SAMBA_SOURCE)
	...
	cp -f package/samba/configure $(SAMBA_DIR)/source/
...
$(SAMBA_DIR)/.install/usr/sbin/smbd: $(SAMBA_DIR)/.compiled
	...
	touch -c $(SAMBA_DIR)/.install/usr/sbin/smbd
...
samba: uclibc $(SAMBA_TARGET_DIR)/usr/sbin/smbd samba_fs_monitor

samba-clean: samba_fs_monitor-clean
...
samba-dirclean: samba_fs_monitor-dirclean
	rm -rf $(SAMBA_DIR)
