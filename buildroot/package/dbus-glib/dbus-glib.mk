...
$(DBUS_GLIB_DIR)/.configured: $(DBUS_GLIB_DIR)/.unpacked /usr/bin/pkg-config
	(cd $(DBUS_GLIB_DIR); rm -rf config.cache; autoconf; \
		...
		DBUS_GLIB_CFLAGS="-I$(STAGING_DIR)/include/glib-2.0 -I$(STAGING_DIR)/lib/glib-2.0/include -I$(STAGING_DIR)/include/glib-2.0/glib -I$(STAGING_DIR)/include/glib-2.0/gobject" \
...
$(STAGING_DIR)/usr/lib/libdbus-glib-1.so.2.0.0: $(DBUS_GLIB_DIR)/$(DBUS_GLIB_BINARY)
	cp -a $(DBUS_GLIB_DIR)/dbus/dbus-glib-error-enum.h $(STAGING_DIR)/usr/include/dbus-1.0/dbus
	cp -a $(DBUS_GLIB_DIR)/dbus/dbus-glib.h $(STAGING_DIR)/usr/include/dbus-1.0/dbus
	cp -a $(DBUS_GLIB_DIR)/dbus/dbus-glib-lowlevel.h $(STAGING_DIR)/usr/include/dbus-1.0/dbus
	cp -a $(DBUS_GLIB_DIR)/dbus/dbus-gtype-specialized.h $(STAGING_DIR)/usr/include/dbus-1.0/dbus
...
dbus-glib-clean:
	...
	rm -f $(STAGING_DIR)/usr/include/dbus-1.0/dbus/dbus-glib*
	rm -f $(STAGING_DIR)/usr/include/dbus-1.0/dbus/dbus-gtype*
