...
#
#############################################################
POPPLER_SOURCE_DIR:=../packages/poppler
POPPLER_DIR:=$(BUILD_DIR)/poppler
...
$(POPPLER_DIR)/.unpacked:
	rm -rf $(POPPLER_DIR)
	cp -a $(POPPLER_SOURCE_DIR) $(BUILD_DIR)
	-$(MAKE) -C $(POPPLER_DIR) clean
	touch $(POPPLER_DIR)/.unpacked

poppler-source: $(POPPLER_DIR)/.unpacked
